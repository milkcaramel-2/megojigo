...
export default function Gallery() {
  ...
  const ricecakeProducts = [
    ...
    { 
      ...
      extendedDescription: "개성 지역 전통 제법으로 만든 고급 주악.\n부드럽고 달콤한 전통의 맛.",
    ...
    { 
      ...
      extendedDescription: "천연 꿀을 넣어 만든 동글동글한 방울떡.\n꿀의 자연스러운 단맛과 쫄깃한 식감.",
    ...
    { 
      id: 31, 
      name: "동부쑥인절미", 
      description: "동부콩과 쑥의 건강한 조화", 
      extendedDescription: "동부콩과 신선한 쑥을 넣은 인절미.\n고소함과 쑥의 향긋함이 어우러진 건강 떡.",
    ...
    { 
      id: 32, 
      name: "오늘의약밥", 
      description: "영양 가득한 전통 약밥", 
      extendedDescription: "찹쌀에 대추, 밤, 견과류를 넣은 영양 약밥.\n달콤하고 구수한 전통의 건강식.",
    ...
    { 
      ...
      extendedDescription: "모시잎으로 감싸 향긋함이 특별한 송편.\n자연의 향과 부드러운 식감이 일품.",
    ...
    { 
      id: 34, 
      name: "무지개설기", 
      description: "아름다운 무지개색 설기", 
      extendedDescription: "천연 색소로 만든 예쁜 무지개색 설기.\n보기에도 아름답고 맛도 뛰어난 떡.",
    ...
    { 
      ...
      extendedDescription: "한 입 크기로 만든 귀여운 미니 두텁떡.\n부드럽고 달콤한 전통의 맛.",
    ...
    { 
      ...
      extendedDescription: "공기처럼 가볍고 부드러운 바람떡.\n입에서 녹는 듯한 부드러운 식감.",
    ...
    { 
      id: 37, 
      name: "백년초꽃송편", 
      description: "백년초로 만든 특별한 송편", 
      extendedDescription: "백년초를 넣어 만든 건강하고 특별한 송편.\n자연의 붉은 빛깔과 은은한 단맛.",
    ...
    { 
      ...
      extendedDescription: "수수가루와 팥을 넣어 만든 영양 떡.\n고소한 수수와 달콤한 팥의 조화.",
    ...
    { 
      id: 41, 
      name: "잣범벅쑥인절미", 
      description: "잣과 쑥이 들어간 특별한 인절미", 
      extendedDescription: "고급 잣과 신선한 쑥을 넣은 프리미엄 인절미.\n잣의 고소함과 쑥의 향긋함이 어우러짐.",
    ...
    { 
      id: 42, 
      name: "제사편", 
      description: "제사상에 올리는 전통 편", 
      extendedDescription: "제사상에 올리는 정성스러운 전통 편떡.\n엄숙하고 정갈한 전통의 맛.",
    ...
    { 
      id: 43, 
      name: "참쑥개떡", 
      description: "참쑥의 진한 향이 담긴 개떡", 
      extendedDescription: "참쑥을 듬뿍 넣어 만든 향긋한 개떡.\n쑥의 진한 향과 쫄깃한 식감이 일품.",
